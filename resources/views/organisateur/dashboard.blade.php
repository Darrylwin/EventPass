        ...
        <div class="bg-card border border-border rounded-xl overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                            ...
                            <td class="px-4 py-3">
                                @if($event->image_path)
                                    <img
                                        ...
                                        alt="{{ $event->title }}"
                                        class="w-16 h-10 object-cover rounded-md border border-border"
                                    >
                                @else
                                    <div class="w-16 h-10 bg-muted rounded-md border border-border flex items-center justify-center">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center text-muted-foreground">Aucun événement pour le moment.</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
