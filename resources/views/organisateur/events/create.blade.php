...
@section('content')
    <div class="max-w-3xl mx-auto space-y-6">
        <div class="flex items-center justify-between gap-4">
            <h1 class="text-3xl font-bold font-display">Créer un événement</h1>
        ...
        <div class="bg-card border border-border rounded-xl p-6">
            <form method="POST" action="{{ route('organisateur.events.store') }}" enctype="multipart/form-data" class="space-y-5">
                @csrf
